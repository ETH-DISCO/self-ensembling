...
def hcaptcha_mask(images, opacity: int, mask_sides=3, mask_per_rowcol=2, mask_num_concentric=2, mask_colors=True):
...
def get_model(
    ...
    if use_hcaptcha_ratio > 0.0:
        ...
        images_train_np[perturbed_indices] = hcaptcha_mask(images_train_np[perturbed_indices], opacity=use_hcaptcha_opacity, mask_sides=mask_sides, mask_per_rowcol=mask_per_rowcol, mask_num_concentric=mask_num_concentric, mask_colors=mask_colors)
