...
#SBATCH --output=/scratch/{{USERNAME}}/slurm/2-resnet-multi-mask/%j.out # redirection of stdout (%j is the job id)
#SBATCH --error=/scratch/{{USERNAME}}/slurm/2-resnet-multi-mask/%j.err # redirection of stderr
