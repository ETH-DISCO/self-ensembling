...
#SBATCH --output=/scratch/yjabary/slurm/job-imagenette/%j.out # redirection of stdout (%j is the job id)
#SBATCH --error=/scratch/yjabary/slurm/job-imagenette/%j.err # redirection of stderr
#SBATCH --nodelist=tikgpu07 # choose specific node
#SBATCH --mem=150G
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
