...
#SBATCH --output=/scratch/yjabary/slurm/job-cifar100/%j.out # redirection of stdout (%j is the job id)
#SBATCH --error=/scratch/yjabary/slurm/job-cifar100/%j.err # redirection of stderr
