...
#SBATCH --output=/scratch/yjabary/slurm/job-2/%j.out # redirection of stdout (%j is the job id)
#SBATCH --error=/scratch/yjabary/slurm/job-2/%j.err # redirection of stderr
